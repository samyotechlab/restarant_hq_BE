...
async def _to_response(doc: dict, db) -> CustomerResponse:
    ...
    return CustomerResponse(
        ...
        campaign_code=doc.get("campaign_code", None),
        campaign_message=doc.get("campaign_message", None),
        campaign_used=doc.get("campaign_used", False),
...
async def _build_responses_optimized(customers: list[dict], db) -> List[CustomerResponse]:
    ...
    for idx, customer_doc in enumerate(customers):
        ...
        response = CustomerResponse(
            ...
            orders=populated_orders,
            campaign_code=customer_doc.get("campaign_code", None),
            campaign_message=customer_doc.get("campaign_message", None),
            campaign_used=customer_doc.get("campaign_used", False),
